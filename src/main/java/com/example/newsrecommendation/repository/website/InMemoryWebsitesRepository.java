...
@Repository
public class InMemoryWebsitesRepository implements WebsiteRepository {
  private static final Logger LOG = LoggerFactory.getLogger(InMemoryWebsitesRepository.class);
